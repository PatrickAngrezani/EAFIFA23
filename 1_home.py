...
if "data" not in st.session_state:
    df_data = pd.read_csv("archive/CLEAN_FIFA23_official_data.csv")
...
st.sidebar.write(
    "Developed by [Patrick Angrezani](https://github.com/PatrickAngrezani)")

btn = st.button("Acesse os dados no Kaggle")
if btn:
    webbrowser.open_new_tab(
        "https://www.kaggle.com/datasets/kevwesophia/fifa23-official-datasetclean-data", new=1)
